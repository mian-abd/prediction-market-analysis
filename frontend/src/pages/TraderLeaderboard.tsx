...
export default function TraderLeaderboard() {
  ...
  const { data: traders, isLoading, error } = useQuery<TraderSummary[]>({
  ...
  if (error || !traders) {
    return (
      <div className="flex flex-col items-center justify-center h-80 gap-3">
        ...
        <p className="text-[14px] font-medium">Failed to load traders</p>
              ...
              <button
                onClick={(e) => {
                  ...
                  if (trader.is_following) {
                    ...
                    followMutation.mutate(trader.user_id)
                  }
                }}
